package Java;/* John wants to decorate a room with wallpaper. He wants a fool-proof method for getting it right.
...
public class EasyWallpaper {
  ...
  public String wallpaper(double l, double w, double h) {
    ...
    if(l<=0 || w<=0 || h <=0){
      ...
      double sizeWall = ((l*h*2) + (h*w*2));
      double rolls = 1.15*(sizeWall/5.2);
      int sizePaper= (int) Math.ceil(rolls);

      String r = list.get(sizePaper);
